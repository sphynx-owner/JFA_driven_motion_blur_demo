...
@export var pre_blur_processor_shader_file : RDShaderFile = preload("res://PreBlurProcessing/pre_blur_processor.glsl"):
	set(value):
		pre_blur_processor_shader_file = value
		_init()

@export var camera_rotation_component : BlurVelocityComponentResource = preload("res://PreBlurProcessing/default_component.tres")
@export var camera_movement_component : BlurVelocityComponentResource = preload("res://PreBlurProcessing/default_component.tres")
@export var object_movement_component : BlurVelocityComponentResource = preload("res://PreBlurProcessing/default_component.tres")
